        ...
        <main className="md:grid md:grid-cols-5 max-w-[1500px] mx-auto py-10 px-15">
            <section className="flex flex-col gap-10 w-full h-full col-span-4 pr-6">
                <div className="flex flex-col gap-4 justify-between">
                    ...
                    <div className="flex gap-10 w-full h-full">
                        ...
                        <button 
                            ...
                            className="btn btn-ghost bg-accent rounded-[15px]"
                        >
                            <SlidersHorizontal />
                            <p>Filtres</p>
                        </button>
                ...
                <div className="grid grid-cols-5 gap-4">
                    {manga.map((item) => (
                        <div key={item.id} className="card bg-accent border border-border rounded-[15px] h-[450px] flex flex-col overflow-hidden">
                            {item.posterImage ? (
                                <Link 
                                    href={`/bibliotheque/manga/${item.slug}`} 
