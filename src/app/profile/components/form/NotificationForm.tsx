        ...
        <div className="flex flex-col gap-4 p-5 bg-accent border border-border rounded-[15px]">
            ...
            <form className="grid grid-cols-2 gap-4" onSubmit={handleSubmitMedias}>
                <div className="flex flex-col gap-2">
                    ...
                    {fieldErrors.comment && (
                        <p className="text-sm text-alerts">{fieldErrors.comment}</p>
                    )}
                </div>
                ...
                <div className="flex flex-col gap-2">
                    ...
                    {fieldErrors.mentions && (
                        <p className="text-sm text-alerts">{fieldErrors.mentions}</p>
                    )}
                </div>
                ...
                <div className="flex flex-col gap-2">
                    ...
                    {fieldErrors.newSorties && (
                        <p className="text-sm text-alerts">{fieldErrors.newSorties}</p>
                    )}
                </div>
