...
function LoginPage() {
    ...
    if ($[0] !== "536d589314b2a535294f2ab8f3b6b3d0d93c21208c867e3d5def22ce41bc8aa1") {
        for(let $i = 0; $i < 20; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "536d589314b2a535294f2ab8f3b6b3d0d93c21208c867e3d5def22ce41bc8aa1";
    }
    ...
    if ($[1] !== email || $[2] !== login || $[3] !== password || $[4] !== router) {
        t0 = ({
            "LoginPage[handleSubmit]": async (e)=>{
                ...
                ;
                try {
                    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/auth/login", {
                        email,
                        password
                    });
    ...
    let t7;
    if ($[12] !== error) {
        t7 = error && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
//# sourceMappingURL=_d1e6a5c1._.js.map