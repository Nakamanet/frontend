...
"[project]/src/app/lib/axios.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AuthProvider({ children }) {
    ...
    const fetchUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        try {
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('/auth/me');
            setUser(data);
            setIsLoggedIn(true);
        } catch  {
            setUser(null);
...
;
function Navbar() {
    const { isLoggedIn, logout, user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__191caadb._.js.map